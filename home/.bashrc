...
export PATH=$HOME/.local/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin:/sbin:/bin:/usr/games:/usr/local/games:/snap/bin:$HOME/.local/bin
...
alias aixenv="source $HOME/.local/bin/activate_aixbrain_env.sh"
alias aixwork="cd  && aixenv"
